...
/*   Updated: 2019/07/12 06:56:51 by sbecker          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libui.h"

static int	get_modal_text_params(t_ui_el *e, t_jnode *n)
{
	int     hash;
	t_jnode *tmp;
...
static int	get_modal_font_color(t_ui_main *m, t_ui_el *e, t_jnode *n)
{
	t_jnode *tmp;
	int     color;
...
static int	ui_el_pref_text_modal_win(t_ui_main *m, t_ui_el *e, t_jnode *n)
{
	char    *tmp_text;
	size_t	num_strs;
	t_jnode *tmp;
