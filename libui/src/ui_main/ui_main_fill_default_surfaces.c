...
/*   Updated: 2019/06/26 18:18:30 by sbednar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ui_main_add_surface_by_path(m, "images/brush_icon_3.png", "brush_icon");
	ui_main_add_surface_by_path(m, "images/fill_icon_2.png", "fill_icon");
	ui_main_add_surface_by_path(m, "images/zoom_icon_2.png", "zoom_icon");
	ui_main_add_surface_by_path(m, "images/eraser_icon_3.png", "eraser_icon");
